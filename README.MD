...
```
* if we want to push what we build to particular  by using below command
```
...
```
docker build -t image-name:version --build-arg variable=value .
```
* **EXAMPLE**
```
